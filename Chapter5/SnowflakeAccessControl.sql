...
CREATE OR REPLACE WAREHOUSE VW1_WH WITH WAREHOUSE_SIZE = 'XSMALL'
    INITIALLY_SUSPENDED = TRUE;

CREATE OR REPLACE WAREHOUSE VW2_WH WITH WAREHOUSE_SIZE = 'XSMALL'
    INITIALLY_SUSPENDED = TRUE; 

CREATE OR REPLACE WAREHOUSE VW3_WH WITH WAREHOUSE_SIZE = 'XSMALL'
    INITIALLY_SUSPENDED = TRUE;
...
CREATE OR REPLACE USER USER3 LOGIN_NAME=COLLLIN;
